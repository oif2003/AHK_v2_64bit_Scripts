...
function __BLOCK() 	# Foldable Comment Block
	"""
	yay

	"""
	if 0>1 # A Crappy comment block that folds and doesn't end correctly, but can be used inside functions.
	    ...
	    #~ Wall of Text Wall of Text Wall of Text Wall of Text Wall of Text
	    #~ Wall of Text Wall of Text Wall of Text Wall of Text Wall of Text
	 end # be sure to indent "end", one space will do
	#This ends the above Comment Block
	
	1#~ Wall of Text Wall of Text Wall of Text Wall of Text Wall of Text
	#~ Wall of Text Wall of Text Wall of Text Wall of Text Wall of Text
	#~ Wall of Text Wall of Text Wall of Text Wall of Text Wall of Text
	#~ Wall of Text Wall of Text Wall of Text Wall of Text Wall of Text
	#~ Wall of Text Wall of Text Wall of Text Wall of Text Wall of Text
